...
//   const { isAuthenticated = false, loading = false } = useSelector((state) => state.auth || {}); // Add fallback

//   useEffect(() => {
//     dispatch(checkAuth); // Invoke the thunk action
//   }, [dispatch]);
...
import { fetchWorkouts } from '../store/slices/userSlice';
import { fetchUserGoals } from '../store/slices/userGoalsSlice';
